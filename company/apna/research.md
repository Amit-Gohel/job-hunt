...
- **Location:** Bengaluru
- **Role title (CSV):** ML/NLP Engineer
- **Salary band (LPA):** 18-30 LPA
- **Funding stage:** 
- **Hiring status:** likely hiring
- **Priority score:** 70
- **Recent signal:** 
- **Match reason:** India's largest job platform 'AI-driven';  matching algorithms; NLP for job-description parsing, candidate-job ranking; 50M+ verified candidates.
- **Cold outreach angle:** 
- **Notes:** NLP-heavy; less GenAI/RAG public work.

## Links

- Company: https://apna.co
- Careers: https://apna.co/careers
- LinkedIn: https://www.linkedin.com/company/apnahq
- Contact: https://employer.apna.co/
- Job URL: https://in.linkedin.com/jobs/apna-jobs
