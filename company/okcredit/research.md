...
- **Location:** Bengaluru
- **Role title (CSV):** Machine Learning Engineer
- **Salary band (LPA):** 20-28 LPA
- **Funding stage:** 
- **Hiring status:** likely hiring
- **Priority score:** 72
- **Recent signal:** 
- **Match reason:** Active MLE role: merchant ledger ML on mixed structured/unstructured/image/text data — explicit OCR + doc AI overlap.
- **Cold outreach angle:** 
- **Notes:** Levels.fyi median SDE ~₹34L. Smaller team but high-ownership.

## Links

- Company: https://okcredit.in
- Careers: https://okcredit.in/career
- LinkedIn: https://in.linkedin.com/company/okcreditofficial
- Contact: https://okcredit.in/contact
- Job URL: https://www.instahyre.com/job-83704-ml-engineer-at-okcredit-bangalore/
