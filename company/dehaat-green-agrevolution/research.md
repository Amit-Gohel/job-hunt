# DeHaat (Green Agrevolution) — Research
...
- **Location:** Gurgaon
- **Role title (CSV):** Data Scientist / ML Engineer (2-4 yrs)
- **Salary band (LPA):** 18-28 LPA
- **Funding stage:** 
- **Hiring status:** actively hiring
- **Priority score:** 65
- **Recent signal:** 
- **Match reason:** Sequoia/Prosus-backed agritech unicorn-adjacent; AI-enabled supply chain + farm decisioning across 5M farmers.
- **Cold outreach angle:** 
- **Notes:** Mostly classical ML / forecasting; match moderate.

## Links

- Company: https://agrevolution.in
- Careers: https://www.instahyre.com/jobs-at-dehaat-green-agrevolution/
- LinkedIn: https://in.linkedin.com/company/dehaatofficial
- Contact: https://agrevolution.in/contact
- Job URL: https://consider.com/boards/vc/sequoia-capital-india/jobs/dehaat?locations=Gurgaon,+India
