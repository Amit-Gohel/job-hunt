...
- **Location:** Bengaluru
- **Role title (CSV):** Computer Vision / Deep Learning Engineer (2-4 yrs)
- **Salary band (LPA):** 18-30 LPA
- **Funding stage:** 
- **Hiring status:** actively hiring
- **Priority score:** 60
- **Recent signal:** 
- **Match reason:** Defense CV/ML; profitable scale-up; ML/CNN/3D-geometry roles; supplies India MoD + exports.
- **Cold outreach angle:** 
- **Notes:** Stack C++/CUDA/CV not Python/RAG — partial fit. Hires from IIT/IISc.

## Links

- Company: https://tonboimaging.com
- Careers: https://tonboimaging.com/defense/careers/
- LinkedIn: https://www.linkedin.com/company/tonbo-imaging
- Contact: https://tonboimaging.com/contact
- Job URL: https://www.jobaaj.com/company/tonbo-imaging-careers
