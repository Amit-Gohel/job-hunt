...
- **Location:** Bengaluru
- **Role title (CSV):** ML Engineer / Data Scientist (Clinical Decision Support)
- **Salary band (LPA):** 18-30
- **Funding stage:** Series B ($23.5M+; Lightspeed, JSW, Kalaari, Chiratae, Avataar, SIG)
- **Hiring status:** likely hiring
- **Priority score:** 78
- **Recent signal:** ISO 27001:2022 certified; 12K+ doctors, 30M+ patients, 370+ cities
- **Match reason:** AI-powered EMR (clinical decision support, ML-driven Rx) across 16 specialties — doc-AI + structured clinical text
- **Cold outreach angle:** 'Building clinical decision support over EMR text is exactly where my doc-AI + RAG (Milvus/Qdrant, multi-model GPT-4o/Gemini) shines — 50K q/mo in prod today.'
- **Notes:** Founders Sandeep Gudibanda, Prasad Basavaraj, Raghuraj Sunder Raju

## Links

- Company: https://www.healthplix.com/
- Careers: https://healthplix.pro/careers-page/
- LinkedIn: https://in.linkedin.com/company/healthplixtech
- Contact: https://www.healthplix.com/overview-healthplix
- Job URL: https://healthplix.pro/careers-page/
