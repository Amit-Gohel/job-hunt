...
- **Location:** Bengaluru
- **Role title (CSV):** Senior / Lead ML Engineer (Speech/ASR) / Sr MLE - NLP / SDE III
- **Salary band (LPA):** 18-28 LPA
- **Funding stage:** 
- **Hiring status:** actively hiring
- **Priority score:** 78
- **Recent signal:** 
- **Match reason:** Series C $213M; building Voice AI + GenAI for contact centers - solid match for Amit's LLM + production AI experience.
- **Cold outreach angle:** 
- **Notes:** Forbes Best Startup Employers; Gartner Cool Vendor.

## Links

- Company: https://www.observe.ai
- Careers: https://www.observe.ai/careers
- LinkedIn: https://www.linkedin.com/company/observeai/
- Contact: https://www.observe.ai/contact
- Job URL: https://in.linkedin.com/jobs/observe-ai-jobs-bengaluru-area-india
