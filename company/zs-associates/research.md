...
- **Location:** Bengaluru
- **Role title (CSV):** AI Engineer - Machine Learning (Max.AI team, 1-3 yrs)
- **Salary band (LPA):** 18-28 LPA
- **Funding stage:** 
- **Hiring status:** actively hiring
- **Priority score:** 93
- **Recent signal:** 
- **Match reason:** Dedicated Max.AI engineering unit building GenAI products; Job ID 32712 Bengaluru 1-3 yrs ML;  Python + MLOps (MLflow) + production ML pipelines;  also Pune & Gurgaon offices.
- **Cold outreach angle:** 
- **Notes:** 127 ZS Associates jobs on Naukri; large GenAI practice across pharma/healthcare.

## Links

- Company: https://www.zs.com
- Careers: https://jobs.zs.com/all/jobs
- LinkedIn: https://in.linkedin.com/company/zs-associates
- Contact: https://www.zs.com/contact-us
- Job URL: https://jobs.zs.com/all/jobs
