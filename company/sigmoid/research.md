...
- **Location:** Bengaluru
- **Role title (CSV):** ML Engineer / GenAI Engineer (2-5 yrs)
- **Salary band (LPA):** 18-28 LPA
- **Funding stage:** 
- **Hiring status:** actively hiring
- **Priority score:** 85
- **Recent signal:** 
- **Match reason:** Peak XV (Sequoia) backed; explicit GenAI + DataOps + LLM practice; Bengaluru is global hub;  uses Python + AWS + vector DBs.
- **Cold outreach angle:** 
- **Notes:** 19 open positions  on Greenhouse; named Leader ISG Specialty Analytics 2024.

## Links

- Company: https://www.sigmoid.com
- Careers: https://www.sigmoid.com/careers/current-openings/
- LinkedIn: https://in.linkedin.com/company/sigmoid-analytics
- Contact: https://www.sigmoid.com/contact-us/
- Job URL: https://job-boards.greenhouse.io/sigmoid
