...
- **Location:** Pune
- **Role title (CSV):** GenAI Engineer / Senior Engineer (Python + LangGraph)
- **Salary band (LPA):** 20-32 LPA
- **Funding stage:** 
- **Hiring status:** actively hiring
- **Priority score:** 90
- **Recent signal:** 
- **Match reason:** Multiple active GenAI engineer roles in Pune; LangChain/LangGraph/Pinecone/Chroma/OpenAI/Claude work  for enterprise customers; strong Python backend focus.
- **Cold outreach angle:** 
- **Notes:** Pune-based; services firm but real GenAI work. Great Place to Work certified.

## Links

- Company: https://www.velotio.com
- Careers: https://www.velotio.com/careers
- LinkedIn: https://www.linkedin.com/company/velotio-technologies
- Contact: https://www.velotio.com/contact-us
- Job URL: https://www.instahyre.com/jobs-at-velotio-technologies/
